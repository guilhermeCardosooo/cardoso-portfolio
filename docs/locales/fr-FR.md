...
cardoso-portfolio
├─ docs
│  ├─ assets                 # Démonstrations et maquettes Figma
│  └─ locales                # Documentation en plusieurs langues
├─ public                    # Photos de profil et ressources statiques
├─ src
│  ├─ app
│  │  ├─ app.config.ts       # Configuration de démarrage standalone
│  │  ├─ app.ts              # Composant racine de l'application
│  │  └─ modules
│  │     ├─ constants        # Dictionnaires de traduction (i18n)
│  │     ├─ models           # DTOs et interfaces de données strictes
│  │     ├─ screens
│  │     │  └─ portfolio     # Composant de la page portfolio
│  │     └─ services         # Gestionnaire d'état réactif (StorageService)
│  ├─ assets
│  │  └─ profile.json        # Données structurées du portfolio
│  ├─ styles.scss            # Variables de thème et réinitialisations globales
│  └─ main.ts                # Point d'entrée de l'application
├─ angular.json              # Configurations de build d'Angular CLI
├─ README.md                 # Documentation technique principale
└─ tsconfig.json             # Configuration stricte du compilateur TS
```
